...
This drop-in replacement fixes a recent change in Swal2 that forces Limonte's political views upon end-users, breaking automated tests and causing other harm along the way.  
